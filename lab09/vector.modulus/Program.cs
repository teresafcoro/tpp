...
namespace TPP.Laboratory.Concurrency.Lab09 {
    ...
    public class VectorModulusProgram {
        ...
        /** ANOTACIÓN:
         * Esta es una implementación concreta de master-worker
         * No tiene por qué ser necesario en todos los casos crear una clase Master y otra Worker
         * Identificar la parte paralelizable lo primero
         * y si se tiene una parte no paralelizable hacerla después
         */
